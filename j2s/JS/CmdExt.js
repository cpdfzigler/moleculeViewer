...
i++;
if (isRock) {
if (this.tokAt (i) != 2 && this.tokAt (i) != 603979967) axis = this.e.optParameterAsString (i++).toLowerCase ();
s = "rotate Y 10 10;rotate Y -10 -10;rotate Y -10 -10;rotate Y 10 10";
s = JU.PT.rep (s, "10", "" + (this.tokAt (i) == 0 || this.tokAt (i) == 603979967 ? 5 : this.intParameter (i++)));
} else {
if (this.tokAt (i) != 603979967) axis = this.e.optParameterAsString (i++).toLowerCase ();
s = "rotate Y 360 30;";
}if (this.chk) return;
this.vwr.setNavigationMode (false);
if (axis === "" || "xyz".indexOf (axis) < 0) axis = "y";
var wf = this.vwr.g.waitForMoveTo;
isTransparent = new Boolean (isTransparent | (this.tokAt (i) == 603979967)).valueOf ();
s = "set waitformoveto true;" + JU.PT.rep (s, "Y", axis) + ";set waitformoveto " + wf;
s = "capture " + JU.PT.esc (fileName) + " -1" + (isTransparent ? " transparent;" : ";") + s + ";capture;";
...
params.put ("type", "GIF");
if (isTransparent || this.tokAt (i) == 603979967) params.put ("transparentColor", Integer.$valueOf (this.vwr.getBackgroundArgb ()));
